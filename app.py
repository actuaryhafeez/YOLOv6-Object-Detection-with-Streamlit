...
weights_path = 'yolov6s6.pt'  # Path to YOLOv6 weights file
...
if source_image is not None:
    ...
    cmd = f'python .\\tools\\infer.py --weights {weights_path} --source {temp_image_path}'
    ...
    output_image_path = 'runs/inference/exp/temp_image.jpg'
